...
public class AuthController extends BaseController {
    ...
    public ApiResponse<ForgotPasswordResponse> forgotPassword(@Valid @RequestBody ForgotPasswordRequest request) {
        ...
        return success("If the account exists, password reset instructions were generated", response);
    }
    ...
    public ApiResponse<Void> changePassword(
        ...
        authService.changePassword(getCurrentUsername(authentication), request);
